...
| [`never-say-never` 🙅](https://github.com/codyhxyz/never-say-never) | Stop hook that catches "can't"/"cannot" in Claude's replies and forces a four-move reframe — name the constraint, list what IS possible, surface tradeoffs, recommend one. Chief-of-staff posture, not refusal posture. |
