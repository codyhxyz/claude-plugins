...
i'm building things constantly — things i deeply care about — and along the way i keep discovering heuristics that work for me. if they work for me, they probably work for someone else too. so in the spirit of open-sourcing myself, i'm open-sourcing the heuristics as plugins. these are ways i work with claude.
...
watch this space. i'm getting obsessed with claude plugins and starting to understand something about them — which is why [`create-claude-plugin`](https://github.com/codyhxyz/create-claude-plugin) exists. i knew i'd be shipping a lot of these.
